@echo off
REM ============================================
REM RustFocus - Script de Lancement
REM ============================================

echo.
echo ========================================
echo    RustFocus - Dofus Window Organizer
echo ========================================
echo.

REM Vérifier si l'executable existe
if exist "src-tauri\target\release\rustfocus.exe" (
    echo [INFO] Lancement de RustFocus...
    echo.
    start "" "src-tauri\target\release\rustfocus.exe"
    echo [OK] RustFocus demarre!
    echo.
...
if exist "src-tauri\target\debug\rustfocus.exe" (
    ...
    echo [OK] RustFocus demarre (mode debug)!
    echo.
    timeout /t 2 /nobreak >nul
    exit /b 0
)
