# ============================================
# Organizer 2.0 - Script Unifié SIMPLIFIÉ
# ============================================
...
function Show-Menu {
    ...
    switch ($choice) {
        "1" {
            Build-Organizer -Release $true
            pause
            Show-Menu
        }
        "2" {
            Build-Organizer -Release $false
            pause
            Show-Menu
        }
        "3" {
            Run-Organizer -Release $true
            pause
            Show-Menu
        }
        "4" {
            Run-Organizer -Release $false
            pause
            Show-Menu
        }
        "5" {
            $success = Build-Organizer -Release $true
            if ($success) {
                Run-Organizer -Release $true
            }
            pause
        ...
        "6" {
            $success = Build-Organizer -Release $false
            if ($success) {
                Run-Organizer -Release $false
            }
            pause
