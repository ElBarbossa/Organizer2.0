# 🛠️ RustFocus - Documentation Développeur

## 🎯 Vue d'Ensemble Technique

RustFocus est une application Windows native pour la gestion de fenêtres multiples Dofus, construite avec **Rust** et **Tauri**. L'architecture sépare clairement le backend (Rust) pour les performances système et le frontend (HTML/CSS/JS) pour l'interface utilisateur.
...
1. Fermer RustFocus
2. Supprimer `%APPDATA%\RustFocus\profiles\current.json`
3. Redémarrer RustFocus
