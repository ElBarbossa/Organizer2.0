# 🎮 Organizer 2.0 - Organisateur de Fenêtres Dofus
...
🔗 **[Télécharger la dernière version](https://github.com/ElBarbossa/Organizer2.0/releases/latest)**

Téléchargez le fichier `Organizer.2.0_X.X.X_portable.exe` depuis la dernière release.
